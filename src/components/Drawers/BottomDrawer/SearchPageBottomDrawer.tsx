...
enum SearchPageBottomDrawerDialogTypes {
	ADD,
	UPDATE
}
								...
								list.listName !== UserLists.BACKLOG && (
									<div key={`${list}_${i}`}>
										<div
											onClick={() =>
												list.hasGame
													? handleOpenDialog(list.listName, SearchPageBottomDrawerDialogTypes.UPDATE)
													: handleOpenDialog(list.listName, SearchPageBottomDrawerDialogTypes.ADD)
											}
...
export default SearchPageBottomDrawer

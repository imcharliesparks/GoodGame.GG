...
type NavMenuProps = {
	menuHandlerText: string
	children: React.ReactNode
}

// Implement children and icon
// Replace other items
const NavMenu = ({ menuHandlerText, children }: NavMenuProps) => {
			...
			<MenuHandler>
				...
				>
					<Typography
						...
						variant="small"
						color="blue-gray"
						className="flex items-center gap-x-2 p-1 font-medium normal-case "
					>

...
import { Navbar, MobileNav, Typography, Button, IconButton, Input, Collapse } from '@material-tailwind/react'
...
const NavHeader = () => {
	...
	const navList = (
		<ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
			<Typography as="li" variant="small" color="blue-gray" className="flex items-center gap-x-2 p-1 font-medium">
				...
				<Link href="/app/user/lists" className="flex items-center">
					My Lists
				</Link>
			</Typography>
			<Typography as="li" variant="small" color="blue-gray" className="flex items-center gap-x-2 p-1 font-medium">
			...
			<Typography as="li" variant="small" color="blue-gray" className="flex items-center gap-x-2 p-1 font-medium">
				...
				<Link href="/app/user/friends/find" className="flex items-center">
					Find a Friend
				</Link>
			</Typography>
			<div className="relative w-full md:max-w-[425px] mt-3 mx-auto">
				<Input
					value={searchTerm}
	...
	return (
		<Navbar id={styles.navbar} className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">

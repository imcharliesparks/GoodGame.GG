...
const AddToListModalContents = ({ setIsModalOpen, lists, handleAddGameToList }: AddToListModalContentsProps) => {
	...
	const handleCheckboxClick = React.useCallback(async (index: number, list: string) => {
		...
		handleAddGameToList(list)

		// TODO: This might be a little wonky and all loading should be handled in /search/games
